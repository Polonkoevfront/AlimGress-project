            ...
            <div className={cls.direction_cooperation}>
               ...
               <div className={cls.cooperation_block}>
                 <div>
                    ...
                    <AppLink className={cls.cooperation_link} to="">
                    <span className={cls.cooperation_link}>Дилерам</span>
                    </AppLink>
                </div>
                <div>
                    <img className={cls.img} src="https://maimoonceramica.ru/wp-content/uploads/2025/01/dizajneram-arhitektoram-stroitelyam.webp" alt="" />
                    <AppLink className={cls.cooperation_link2} to="">
                    <span className={cls.cooperation_link2}>Дизайнерам, архитекторам</span>
